  ...
  return (
    <>
      ...
      <div className="px-[32px] py-[24px] flex flex-col gap-[24px] max-w-[700px]">
        ...
        {/* Account */}
        <div>
          <p className="font-['Inter',sans-serif] font-medium text-[11px] text-[var(--grey-muted)] uppercase tracking-[1px] mb-[10px] px-[4px]">Account</p>
          <div className={`${cardBase} overflow-hidden`}>
            {[
              { label: "Change Password", color: "var(--text-body)" },
