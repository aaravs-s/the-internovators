...
export default function UserProfilePage() {
  ...
  return (
    <>
      <header className="flex items-center gap-[12px] border-b border-[var(--white-transparent)] px-[32px] pb-[17px] pt-[28px]">
        <button onClick={() => navigate("/social")} className="rounded-[12px] border border-[var(--border-grey)] bg-[var(--white-transparent)] px-[14px] py-[9px] text-[13px] text-[var(--text-body)]">← Back</button>
        <div><h1 className="text-[32px] font-bold text-white">@{profile.username}</h1><p className="text-[13px] text-[var(--grey-muted)]">Walking Community profile</p></div>
      </header>
