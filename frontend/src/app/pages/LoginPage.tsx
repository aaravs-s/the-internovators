  ...
  return (
    <div className="flex flex-col gap-[0]">
      <div className="mb-[28px]">
        ...
        <p className="font-['Inter',sans-serif] font-normal text-[14px] text-[var(--grey-muted)]">Welcome back — your city awaits.</p>
      </div>
      ...
      <div className="flex items-center gap-[12px] mt-[20px]">
        <div className="flex-1 h-px bg-[var(--white-transparent)]" />
        <span className="font-['Inter',sans-serif] font-normal text-[12px] text-[var(--grey-muted)]">or continue with</span>
        <div className="flex-1 h-px bg-[var(--white-transparent)]" />
      </div>
      ...
      <div className="flex gap-[10px] mt-[16px]">
        {["Google", "Apple"].map((p) => (
          <button key={p} onClick={() => navigate("/home")}
            className="flex-1 h-[44px] bg-[var(--white-transparent)] border border-[var(--border-grey)] rounded-[12px] flex items-center justify-center gap-[8px] cursor-pointer hover:bg-[var(--grey-muted)] transition-colors">
