        ...
        <div className="relative">
          <div className="absolute left-[16px] top-1/2 -translate-y-1/2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <circle cx="7" cy="7" r="5" stroke="var(--grey-muted)" strokeWidth="1.5" />
              <path d="M11 11l3 3" stroke="var(--grey-muted)" strokeLinecap="round" strokeWidth="1.5" />
            </svg>
          </div>
            ...
            <div key={route.id} className={`${cardBase} overflow-hidden`}>
              <div className="w-full h-[220px] overflow-hidden relative">
                <RouteMap
                  ...
                  fallbackImage={route.image_url ?? imgRouteMap}
                  mode="preview"
